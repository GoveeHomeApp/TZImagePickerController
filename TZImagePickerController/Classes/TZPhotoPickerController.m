        ...
        if (isSelected) {
            ...
            if (tzImagePickerVc.selectedModels.count < tzImagePickerVc.maxImagesCount) {
                ...
                if (model.type == TZAssetModelMediaTypeVideo) {
                    ...
                    if (videoTime > tzImagePickerVc.allowVideoMaximumDuration) {
                        [tzImagePickerVc showAlertWithTitle:[NSBundle tz_localizedStringForKey:@"AllowVideoMaximumDuration"]];
                        return;
                    }
                    if (videoTime < tzImagePickerVc.allowVideoMinimumDuration) {
                        [tzImagePickerVc showAlertWithTitle:[NSBundle tz_localizedStringForKey:@"VideoTooShort"]];
                        return;
                    }
                }
